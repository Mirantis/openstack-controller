...
OSCTL_EXPORTER_ENABLED_COLLECTORS = os.getenv(
    ...
    "osdpl_certificate,osdpl_credentials,osdpl_nova,osdpl_ironic,osdpl_keystone,osdpl_heat,osdpl_glance,osdpl_manila,osdpl_cinder,osdpl_neutron,osdpl_octavia,osdpl_api,osdpl_aodh,osdpl",
).split(",")
