...
function update_nova_ssh_keys {
    ...
    kubectl create secret generic generated-nova-ssh-creds --from-file=${extract_local}/${temp} -n openstack || die $LINENO "Failed to update nova ssh key generated-nova-ssh-creds"
